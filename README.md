...
> A rothko painting of rectangular art pieces using CSS and Box Model.
...
[Live Demo Link](https://fcc-rothko-painting-ismail.netlify.app/)
...
```bash
git clone git@github.com:ismailadekunle/06-fcc-rothko-painting.git
